...
<body>
                    ...
                    <?php foreach ($agendamentos as $med): ?>
                        <div class="med-card fade-in">
                            ...
                            <?php if (!empty($med["imagem"])): ?>
                                <img src="<?= htmlspecialchars($med["imagem"]) ?>" alt="<?= htmlspecialchars($med["med_nome"]) ?>" class="med-image">
                            <?php endif; ?>
  ...
  <div class="meds-grid quick-add-grid">
    <?php
    $remedios = [
      "Dipirona" => [
        "link" => "https://www.saojoaofarmacias.com.br/dipirona-sodica-generico-prati-donaduzzi-500mg-30-comprimidos-10004407/p",
        "descricao" => "Alivia dores e febre."
      ],
      "Paracetamol" => [
        "link" => "https://www.saojoaofarmacias.com.br/paracetamol-750mg-20-comprimidos-generico-globo-10040354/p",
        "descricao" => "Analgésico e antitérmico."
      ],
      "Ibuprofeno" => [
        "link" => "https://www.saojoaofarmacias.com.br/ibuprofeno-600mg-20-comprimidos-13308/p",
        "descricao" => "Anti-inflamatório e analgésico."
      ],
      "Amoxicilina" => [
        "link" => "https://www.saojoaofarmacias.com.br/amoxicilina-500mg-generico-cimed-21-capsulas-duras-10091320/p",
        "descricao" => "Antibiótico para infecções."
      ],
      "Losartana" => [
        "link" => "https://www.saojoaofarmacias.com.br/busca?q=losartana",
        "descricao" => "Controla a pressão arterial."
      ],
      "Sinvastatina" => [
        "link" => "https://www.saojoaofarmacias.com.br/busca?q=sinvastatina",
        "descricao" => "Reduz o colesterol."
      ]
    ];
    foreach ($remedios as $nome => $dados): 
      $img = strtolower(str_replace(\'ç\', \'c\', preg_replace(\'/[^\\w]/\', \'\', iconv(\'UTF-8\', \'ASCII//TRANSLIT\', $nome))))) . \'.jpg\';
    ?>
      <div class="med-card quick-add-card">
        <img src="images/<?= $img ?>" alt="<?= htmlspecialchars($nome) ?>" class="quick-add-image">
        <h3 class="quick-add-name"><?= htmlspecialchars($nome) ?></h3>
        <p class="quick-add-description"><?= htmlspecialchars($dados[\"descricao\"]) ?></p>
        <a class="btn btn-secondary btn-small" href="<?= htmlspecialchars($dados[\"link\"]) ?>" target="_blank">Comprar</a>
      </div>
    <?php endforeach; ?>
  </div>
